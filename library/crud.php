...
class Database {
    ...
    private $db_user = "database_username";  // Change as required
    private $db_pass = "database_password";  // Change as required 
    private $db_name = "database_name"; // Change as required
